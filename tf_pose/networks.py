...
def get_graph_path(model_name):
    dyn_graph_path = {
        ...
        # ----- Self-added openpose model -----#
        'mobilenet_frozen-opt-model': 'graph/self_trained/frozen-opt-model.pb', 
        'mobilenet_v2_trt_int8': 'trt_models/trt_tfopenpose_models_int8.pb',
        'mobilenet_v2_trt_final': 'trt_models/trt_mobilev2_final_models.pb',
        "trt_tfopenpose_models_fp16":"trt_models/trt_tfopenpose_models_fp16.pb",
        "trt_tfopenpose_models_fp32":"trt_models/trt_tfopenpose_models_fp32.pb",
    }
